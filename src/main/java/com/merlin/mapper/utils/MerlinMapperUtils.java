package com.merlin.mapper.utils;
...
public class MerlinMapperUtils {
            ...
            if (
                ...
                // set value for single object
                    ...
                    if (MiluMapperUtils.isNestedField(targetAnnotatedField)) {
                        ...
                        MerlinMapperUtils nestedMerlinMapperUtils = new MerlinMapperUtils();
                        Object targetNestedObject = nestedMerlinMapperUtils.mapSingleObject(sourceFieldValue, setterParameterType);
